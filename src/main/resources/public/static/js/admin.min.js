...
jQuery( function() {
    ...
    // 滚动条
    const ps = new PerfectScrollbar('.sidemenubar-scroll', {
		swipeEasing: true,
        wheelSpeed: 2,
    ...
    // 侧边栏
    $(".apollo-aside-toggler").bind('click', function(){
        $(".apollo-layout-container").toggleClass("expand")
    });
