...
((function ($) {
    ...
    defaultLayoutTemplates = {
        ...
        default: '<div class="mt-wrapper {mainClass}" style="height: 100%;" >' +
            ...
            '<li class="mt-move-left"><a><i class="fa fa-angle-double-left"></i></a></li>' +
            '</ul>' +
            '</div>' +
            ...
            '<ul  class="nav {nav-tabs}">' +
            '<li class="mt-move-right"><a><i class="fa fa-angle-double-right"></i></a></li>' +
            '<li class="header-menu dropdown">' +
            '<a class="dropdown-toggle" href="#" id="tabMenuDrop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">' +
            '{dropdown}<span class="caret"></span></a>' +
            '<div class="dropdown-menu" aria-labelledby="tabMenuDrop">' +
            '<a class="dropdown-item mt-show-actived-tab"><i class="mdi mdi-account"></i>{showActivedTab}</a>' +
            '<a class="dropdown-item mt-close-all-tabs"><i class="mdi mdi-account"></i>{closeAllTabs}</a>' +
            '<a class="dropdown-item mt-close-other-tabs"><i class="mdi mdi-account"></i>{closeOtherTabs}</a>' +
            '</div>' +
            '</li>' +
            '</ul>' +
            '</div>' +
